...
Each URL is mapped to a view function in the 'views' module. When Django encounters an incoming URL, it checks the 'urlpatterns' list from top to bottom until it finds a matching pattern.
"""
